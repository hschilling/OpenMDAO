...
class SqliteRecorder(BaseRecorder):
    ...
    def record_iteration_driver(self, object_requesting_recording, desvars,
        ...
        super(SqliteRecorder, self).record_iteration_driver(object_requesting_recording, desvars,
