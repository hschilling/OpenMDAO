...
prob = om.Problem()
meta = om.MetaModelStructuredComp(method='slinear')
mm = prob.model.add_subsystem('mm', meta,
                            promotes=['x0', 'x1'])
...
prob.set_val('mm.x0', 2.1)
prob.set_val('mm.x1', 56.1)
print(prob.get_val('mm.f'))

# Now that the model has been trained, put it into a new problem

prob2 = om.Problem()
mm2 = prob2.model.add_subsystem('mm', meta, promotes=['x0', 'x1'])
# mm2.add_input('x0', 0.0)
# mm2.add_input('x1', 0.0)
# mm2.add_output('f', 0.0)

prob2.setup()
prob2.final_setup()

prob2.set_val('mm.x0', 2.1)
prob2.set_val('mm.x1', 56.1)
print(prob2.get_val('mm.f'))
