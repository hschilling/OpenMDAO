...
tf_model = tf.keras.Sequential(
    [
        ...
        # Hidden layer 1: 128 neurons with leaky_relu activation
        tf.keras.layers.Dense(2**7, activation="leaky_relu",
                                kernel_regularizer=tf.keras.regularizers.l2(0.0001)  # Very light regularization
                                ),
        tf.keras.layers.Dropout(0.1),  # Back to original light dropout
        # Hidden layer 2: 128 neurons with leaky_relu activation
        tf.keras.layers.Dense(2**7, activation="leaky_relu",
                                kernel_regularizer=tf.keras.regularizers.l2(0.0001)  # Very light regularization
                                ),
        tf.keras.layers.Dropout(0.1),  # Back to original light dropout
...
early_stop = tf.keras.callbacks.EarlyStopping(
    monitor='val_loss',  # Monitor validation loss to catch overfitting
    patience=30,  # Allow more epochs before stopping - balance between overfitting and performance
    verbose=1,
    mode='min',
